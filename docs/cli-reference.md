...
| `--progress <quiet\|compact\|verbose>` | Build output style. Whichever style is chosen, a warning names the last build step when the engine prints nothing for 3 minutes, which usually means a stalled download |
