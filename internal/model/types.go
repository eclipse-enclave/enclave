...
const (
	AppName = "enclave"
	// ToolAuto is the unset tool value: a command that needs a tool asks once
	// which agent to use and saves the answer when it can, and fails naming
	// --tool and the "tool" key when it cannot.
	ToolAuto = "auto"
